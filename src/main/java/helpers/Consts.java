...
public class Consts {
    ...
    static final String SALARY_PATTERN = "^\\d*\\.?\\d*$";

    public static final String employeeNameColumnName = "name";
    public static final String employeeEmailColumnName = "email";
    public static final String employeeSalaryColumnName = "salary";
}
